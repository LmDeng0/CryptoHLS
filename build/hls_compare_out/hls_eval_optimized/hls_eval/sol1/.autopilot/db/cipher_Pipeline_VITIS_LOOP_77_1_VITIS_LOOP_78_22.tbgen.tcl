set moduleName cipher_Pipeline_VITIS_LOOP_77_1_VITIS_LOOP_78_22
set isTopModule 0
...
set C_modelName {cipher_Pipeline_VITIS_LOOP_77_1_VITIS_LOOP_78_22}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 0 1 } 1 1 }  }
	{ RoundKey int 8 regular {array 176 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 4 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_address1 MemPortADDR2 1 4 }  { state_ce1 MemPortCE2 1 1 }  { state_q1 MemPortDOUT2 0 8 } } }
